...
static int
ti_eqep_edge_capture_unit_prescalar_read(struct counter_device *counter,
					 u32 *value)
{
	struct ti_eqep_cnt *priv = counter->priv;
	u32 qcapctl;
...
static int
ti_eqep_edge_capture_unit_prescalar_write(struct counter_device *counter,
					  u32 value)
{
	struct ti_eqep_cnt *priv = counter->priv;
...
static const char *const ti_eqep_edge_capture_unit_prescalar_values[] = {
	"1",
	"2",
	"4",
	"8",
...
static DEFINE_COUNTER_ENUM(ti_eqep_edge_capture_unit_prescalar_available,
			   ti_eqep_edge_capture_unit_prescalar_values);
...
static struct counter_comp ti_eqep_device_ext[] = {
	...
	COUNTER_COMP_DEVICE_ENUM("edge_capture_unit_prescalar",
				 ti_eqep_edge_capture_unit_prescalar_read,
				 ti_eqep_edge_capture_unit_prescalar_write,
				 ti_eqep_edge_capture_unit_prescalar_available),
